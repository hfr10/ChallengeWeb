...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <h1 class="text-3xl font-bold">Commande #<?= htmlspecialchars($order->order_number) ?></h1>
            <p class="text-gray-500">Passée le <?= date('d/m/Y à H:i', strtotime($order->created_at)) ?></p>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <p class="text-gray-600">
                    Statut: <span class="font-medium text-green-600">
